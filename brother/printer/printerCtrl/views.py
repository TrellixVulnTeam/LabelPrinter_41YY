...
class PrintProduct(mixins.ListModelMixin,
    ...
    def post(self, request, *args, **kwargs):
        ...
        urllib.request.urlretrieve(data['ImageURL'], "../printer/QRFiles/" + data['ProductId'] + data['dataFormat'])
        print("Creating bin file for image " + "../printer/QRFiles/" + data['ProductId'] + data['dataFormat'])
        excute_order="brother_ql_create --model QL-710W " + "../printer/QRFiles/" + data['ProductId'] + data['dataFormat'] + " > " + data['ProductId'] + ".bin"
